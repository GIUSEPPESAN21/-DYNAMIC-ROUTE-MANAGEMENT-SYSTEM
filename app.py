...
# VERSIÓN 10.1 - CORRECCIÓN DE VISUALIZACIÓN DE SECUENCIA
...
def optimize_routes_full():
    ...
    try:
        ...
        for vehiculo_id, paradas_ids in rutas_asignadas.items():
            ...
            # --- ¡CORRECCIÓN CLAVE! ---
            # Crear la lista de paradas en el orden correcto de la secuencia
            ...
            ruta_resultado = {
                ...
                "paradas_info": paradas_info_ordenadas, # Enviar la lista ya ordenada
...
if __name__ == '__main__':
    print("\n🚀 Servidor de optimización de rutas v10.1 (Secuencia Corregida) iniciado.")
    print("   - Algoritmo: Optimización por capacidad (Cero Sobrecupo).")
    print("   - Funciones: Análisis con IA, Gestión Manual, Cálculo de Costos.")
